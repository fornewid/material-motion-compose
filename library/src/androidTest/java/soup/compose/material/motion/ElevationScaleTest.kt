...
class ElevationScaleTest {
    ...
    @Test
    fun elevationScaleTest_showsContent() {
        rule.mainClock.autoAdvance = false

        rule.setContent {
            val showFirst by remember { mutableStateOf(true) }
            ElevationScale(showFirst) {
    ...
    @Test
    fun elevationScaleTest_disposesContentOnChange() {
        rule.mainClock.autoAdvance = false
    ...
    @Test
    fun elevationScaleTest_rememberSaveableIsNotRecreatedForScreens() {
        rule.mainClock.autoAdvance = false
